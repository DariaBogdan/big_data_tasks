...
public class MonitoringRecord implements Serializable {
    ...
    public String toString() {
        return "MonitoringRecord [stateCode=" + stateCode + ", countryCode=" + countryCode + ", siteNum=" + siteNum
    ...
    public static MonitoringRecord fromJson(String json) throws IOException {
        ObjectMapper mapper = new ObjectMapper();
        return mapper.readValue(json, MonitoringRecord.class);
    }
